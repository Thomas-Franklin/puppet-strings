...
class PuppetStrings::Yard::CodeObjects::TransportSchemas < PuppetStrings::Yard::CodeObjects::Group
...
class PuppetStrings::Yard::CodeObjects::TransportSchema < PuppetStrings::Yard::CodeObjects::Base
  ...
  # @return [void]
  def initialize(name)
    super(PuppetStrings::Yard::CodeObjects::TransportSchemas.instance, name)
  end

  # Gets the type of the code object.
  # @return Returns the type of the code object.
  def type
    :puppet_transport_schema
  end
